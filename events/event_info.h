...
typedef enum {
    ...
    NETOS_EVENT_DESC_TCP_FLAGS_SYN_FIN_SET              = 0x00004004,
    NETOS_EVENT_DESC_TCP_FLAGS_SYN_RST_SET              = 0x00004005,
    NETOS_EVENT_DESC_TCP_FLAGS_SYN_PSH_SET              = 0x00004006,
    NETOS_EVENT_DESC_TCP_FLAGS_RST_PSH_SET              = 0x00004007,
